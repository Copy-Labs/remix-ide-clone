...
export const getFileTypeIcon = (fileName: string, fileType: 'file' | 'folder', isExpanded?: boolean): React.ComponentType<any> => {
  if (fileType === 'folder') {
...
export const getFileTypeCategory = (fileName: string): string => {
  ...
  const categories: Record<string, string[]> = {
    'code': ['js', 'jsx', 'ts', 'tsx', 'py', 'java', 'cpp', 'c', 'cs', 'php', 'rb', 'go', 'rs', 'swift', 'kt', 'scala', 'sol', 'vy', 'html', 'htm', 'css', 'scss', 'sass', 'less', 'vue', 'svelte'],
